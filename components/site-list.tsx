            ...
            <HoverCard key={site.analysisId}>
              <HoverCardTrigger>
                <Link
                  ...
                  className="group"
                >
                  <Card className="flex h-36 flex-col break-all border-2 border-transparent shadow-md transition-colors hover:border-primary/50 hover:shadow-lg dark:bg-accent/50">
