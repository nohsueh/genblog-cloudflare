/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 610991a63a51adbc3ba43663cc90dd6b)
// Runtime types generated with workerd@1.20250508.0 2025-05-05 global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_APP_NAME: string;
		NEXT_PUBLIC_ROOT_DOMAIN: string;
		SEARCHLYSIS_API_KEY: string;
		PASSWORD: string;
		NEXT_PUBLIC_BASE_PATH: string;
		NEXT_PUBLIC_APP_DESCRIPTION: string;
		NEXT_PUBLIC_FOOTER_RESOURCE_LINKS: string;
		NEXT_PUBLIC_ICON: string;
		NEXT_PUBLIC_IMAGE: string;
		NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION: string;
		NEXT_PUBLIC_GOOGLE_ADSENSE_ACCOUNT: string;
		NEXT_PUBLIC_YANDEX_ADUNIT_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_APP_NAME" | "NEXT_PUBLIC_ROOT_DOMAIN" | "SEARCHLYSIS_API_KEY" | "PASSWORD" | "NEXT_PUBLIC_BASE_PATH" | "NEXT_PUBLIC_APP_DESCRIPTION" | "NEXT_PUBLIC_FOOTER_RESOURCE_LINKS" | "NEXT_PUBLIC_ICON" | "NEXT_PUBLIC_IMAGE" | "NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION" | "NEXT_PUBLIC_GOOGLE_ADSENSE_ACCOUNT" | "NEXT_PUBLIC_YANDEX_ADUNIT_ID" | "NEXT_PUBLIC_APP_TYPE" | "NEXT_PUBLIC_GOOGLE_ANALYTICS_MEASUREMENT_ID">> {}
}
